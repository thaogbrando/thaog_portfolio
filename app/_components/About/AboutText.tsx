        ...
        >
            <div className="grid gap-x-8 gap-y-6 md:grid-cols-[2fr,1fr] max-w-[1200px]">
                ...
                <Image
                    ...
                    src={Me}
                    className="row-start-1 max-w-[330px] md:max-w-sm md:col-start-2 md:row-end-3 -rotate-2 hover:rotate-0 transition-all ease-in-out duration-500 aspect-square overflow-hidden rounded-3xl border-2 border-dark-secondary hover:grayscale"
                />
            </div>
            <button
                    onClick={handleClick}
