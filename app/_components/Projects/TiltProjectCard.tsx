...
const TiltProjectCard = ({ title, year, hasRepo, freelance, link, repo, desc, tech }: TildCardProps) => {
    ...
    return (
        <div ref={cardRef} className='relative cursor-pointer w-80 md:w-96 h-[475px] md:h-[435px] bg-dark-primary/20 dark:bg-dark-accent/20 backdrop-blur-xl overflow-hidden rounded-3xl shadow-2xl'
            style={{
        ...
        >
            ...
            <div className="absolute inset-0 p-6 flex flex-col justify-between z-20 text-light-text dark:text-dark-text">
                ...
                <div className='flex flex-col justify-center gap-3 text-sm'>
                    ...
                    <p className='text-sm py-4 font-semibold tracking-wide text-light-text/90 dark:text-dark-text/90'>{desc}</p>
                </div>
                <div>
