...
const TiltProjectCard = ({ title, year, hasRepo, freelance, link, repo, desc, tech }: TildCardProps) => {
    ...
    return (
        <div ref={cardRef} className='relative cursor-pointer w-80 md:w-96 h-[460px] md:h-[435px] bg-dark-primary/20 dark:bg-dark-accent/20 backdrop-blur-xl overflow-hidden rounded-3xl shadow-2xl'
            style={{
