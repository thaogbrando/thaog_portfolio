...
export const integrations = [
    ...
    },
    {
        name: 'NodeJs',
        icon: 'devicon:nodejs',
        desc: 'Node.Js brings the necessary tools to make bots possible on Discord.'
    },
    {
        name: 'JavaScript',
        icon: 'vscode-icons:file-type-js-official',
        desc: 'JavaScript is the secret weapon for increased user experience.'
    },
    {
        name: 'NextJs',
    ...
    },
    {
        name: 'FramerMotion',
        icon: 'gg:framer',
        desc: "Who wouldn't want the best of the best animation libs for fresh interactivity."
    }
];

export const intergrations2 = [
    {
        name: 'ReactJs',
        icon: 'devicon:react',
    ...
    },
    {
        name: 'Sanity',
        icon: 'devicon:sanity',
        desc: 'The best Headless CMS for outstanding backend content management.'
    },
    {
        name: 'CSS',
